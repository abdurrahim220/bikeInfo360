  ...
  const specifications = {
    ...
    chassis: [
      ...
      { label: "Front Suspension", value: "Inverted Telescopic" },
      {
        ...
        value: "Swing arm with Monoshock (Pro-Link)",
      },
    ],
  };
        ...
        <div className="space-y-6">
          <div className="space-y-4">
            ...
            <h1 className="text-2xl font-bold">
              HONDA CBR 150R DOMINOR BLACK ABS INDONESIA
            </h1>
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                ...
                <a href="#" className="text-primary">
                  More Bike From Honda
                </a>
              </p>
              <p className="text-sm text-muted-foreground">
                Product Code: CBR150IN
              </p>
            </div>
          </div>
          ...
          <CardContent className="mt-6">
            <TabsContent value="description">
              <h2 className="text-xl font-bold mb-4">
                HONDA CBR 150R DOMINOR BLACK ABS INDONESIA SUMMARY
              </h2>
              <p className="text-muted-foreground">
                A powerful sports motorcycle featuring advanced technology and
            ...
            <TabsContent value="specifications">
              <div className=" grid grid-cols-2 gap-4 lg:grid-cols-3">
                ...
                <div>
                  <h3 className="text-lg font-bold  p-3 rounded-lg mb-4">
                    ENGINE
                  </h3>
                  <div className="grid gap-2">
                    {specifications.engine.map((spec, index) => (
                      <div
                        key={index}
                        className="grid grid-cols-2 p-2 odd:bg-muted/50"
                      >
                ...
                {/* Body Dimensions */}
                <div>
                  <h3 className="text-lg font-bold bg-primary/10 p-3 rounded-lg mb-4">
                    Body Dimensions
                  </h3>
                  <div className="grid gap-2">
