...
export const Footer = () => {
  return (
    <div className="max-w-screen-xl mx-auto">
      {/* top area block */}
      <div className="grid sm:grid-cols-12 gap-8 mt-2 md:py-12 border-t border-zinc-200">
        {/*1st block  */}
        ...
        <div className="sm:col-span-6 md:col-span-3 lg:col-span-6 max-sm:order-1 flex flex-col ">
          ...
          <ul className="flex space-x-4 mt-4 mb-1">
            <li>
              <a
                className="flex justify-center items-center text-zinc-700 hover:text-zinc-900 transition dark:text-white"
                href="#0"
                aria-label="Twitter"
              >
                <svg
        ...
        {/* 2nd block */}
        <div className="sm:col-span-6 md:col-span-3 lg:col-span-2 mt-2 lg:mt-0">
          <h6 className="text-sm text-zinc-800 font-semibold dark:text-white mb-2">
            Company
          </h6>
        ...
        <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
          <h6 className="text-sm text-zinc-800 font-semibold mb-2 dark:text-white ">
            Resources
          </h6>
          <ul className="text-sm space-y-2">
            <li>
              <a
                className="text-zinc-500 dark:text-white hover:text-zinc-900 transition"
                href="#0"
              >
                Community
              </a>
        ...
        <div className="sm:col-span-6 md:col-span-3 lg:col-span-2 ">
          ...
          <ul className="text-sm space-y-2 ">
            <li>
              <a
                className="text-zinc-500 hover:text-zinc-900 transition dark:text-white"
                href="#0"
              >
                Refund policy
              </a>
            ...
            <li>
              <a
                className="text-zinc-500 hover:text-zinc-900 dark:text-white transition"
                href="#0 "
              >
                Terms & Conditions
              </a>
